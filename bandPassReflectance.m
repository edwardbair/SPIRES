...
function [ R,varargout ] = bandPassReflectance(lambda,lambdaUnit,spectralReflectance,solarRad,varargin)
% [ R ] = bandPassReflectance(lambda, lambdaUnit, spectralReflectance,
%   spectralIrradiance, name/value pairs)
% [ R ] = bandPassReflectance(lambda, lambdaUnit, spectralReflectance,
%   spectralIrradiance, name/value pairs)
% [R, bandPass] = bandPassReflectance(________________)
