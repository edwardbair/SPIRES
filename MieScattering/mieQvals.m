...
%parameters needed to calculate fluxes, i.e. efficiencies for extinction,
%scattering, absorption, and radiation pressure along with single scattering
%albedo and Mie asymmetry parameter.
